...
class BaseStudentProject(_PrismaModel):
    __prisma_model__: ClassVar[Literal['StudentProject']] = 'StudentProject'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.StudentProjectActions[_PrismaModelT]':
        from .client import get_client

        return actions.StudentProjectActions[_PrismaModelT](client or get_client(), cls)
